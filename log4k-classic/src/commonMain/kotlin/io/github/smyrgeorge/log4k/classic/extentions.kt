...
//@formatter:off
inline fun Logger.trace(f: () -> String): Unit = if (TRACE.isEnabled()) trace(f()) else Unit
inline fun Logger.trace(t: Throwable, f: () -> String): Unit = if (TRACE.isEnabled()) trace(f(), t) else Unit
inline fun Logger.debug(f: () -> String): Unit = if (DEBUG.isEnabled()) debug(f()) else Unit
inline fun Logger.debug(t: Throwable, f: () -> String): Unit = if (DEBUG.isEnabled()) debug(f(), t) else Unit
inline fun Logger.info(f: () -> String): Unit = if (INFO.isEnabled()) info(f()) else Unit
inline fun Logger.info(t: Throwable, f: () -> String): Unit = if (INFO.isEnabled()) info(f(), t) else Unit
inline fun Logger.warn(f: () -> String): Unit = if (WARN.isEnabled()) warn(f()) else Unit
inline fun Logger.warn(t: Throwable, f: () -> String): Unit = if (WARN.isEnabled()) warn(f(), t) else Unit
inline fun Logger.error(f: () -> String): Unit = if (ERROR.isEnabled()) error(f()) else Unit
inline fun Logger.error(t: Throwable, f: () -> String): Unit = if (ERROR.isEnabled()) error(f(), t) else Unit

inline fun Logger.trace(span: Span, f: () -> String): Unit = if (TRACE.isEnabled()) trace(span, f()) else Unit
inline fun Logger.trace(span: Span, t: Throwable, f: () -> String): Unit = if (TRACE.isEnabled()) trace(span, f(), t) else Unit
inline fun Logger.debug(span: Span, f: () -> String): Unit = if (DEBUG.isEnabled()) debug(span, f()) else Unit
inline fun Logger.debug(span: Span, t: Throwable, f: () -> String): Unit = if (DEBUG.isEnabled()) debug(span, f(), t) else Unit
inline fun Logger.info(span: Span, f: () -> String): Unit = if (INFO.isEnabled()) info(span, f()) else Unit
inline fun Logger.info(span: Span, t: Throwable, f: () -> String): Unit = if (INFO.isEnabled()) info(span, f(), t) else Unit
inline fun Logger.warn(span: Span, f: () -> String): Unit = if (WARN.isEnabled()) warn(span, f()) else Unit
inline fun Logger.warn(span: Span, t: Throwable, f: () -> String): Unit = if (WARN.isEnabled()) warn(span, f(), t) else Unit
inline fun Logger.error(span: Span, f: () -> String): Unit = if (ERROR.isEnabled()) error(span, f()) else Unit
inline fun Logger.error(span: Span, t: Throwable, f: () -> String): Unit = if (ERROR.isEnabled()) error(span, f(), t) else Unit
